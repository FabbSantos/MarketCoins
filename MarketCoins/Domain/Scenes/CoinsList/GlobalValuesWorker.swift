...
class GlobalValuesWorker {
    ...
    private var completion: ((Result<GlobalModel?, CryptocurrencyError>) -> Void)?
    ...
    func doFetchGlobalValues(completion: @escaping ((Result<GlobalModel?, CryptocurrencyError>) -> Void)) {
